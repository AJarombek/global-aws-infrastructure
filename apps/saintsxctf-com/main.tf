...
module "saintsxctf-com-vpc" {
  ...
  # Mandatory arguments
  name = "saints-xctf-com"
  tag_name = "saints-xctf-com"
  ...
  public_subnet_names = ["saints-xctf-com-lisag-public-subnet", "saints-xctf-com-megank-public-subnet"]
