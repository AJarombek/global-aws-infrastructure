...
class TestRoute53(unittest.TestCase):
    ...
    def test_jarombek_io_zone_exists(self) -> None:
        ...
        zones = self.route53.list_hosted_zones_by_name(
            DNSName="jarombek.io.", MaxItems="1"
        ).get("HostedZones")
    ...
    def test_jarombek_io_ns_record_exists(self) -> None:
        ...
        self.assertTrue(
            a_record.get("Name") == "jarombek.io." and a_record.get("Type") == "NS"
        )
    ...
    def test_jarombek_io_a_record_exists(self) -> None:
        ...
        self.assertTrue(
            a_record.get("Name") == "jarombek.io." and a_record.get("Type") == "A"
        )
    ...
    def test_www_jarombek_io_a_record_exists(self) -> None:
        ...
        self.assertTrue(
            a_record.get("Name") == "www.jarombek.io." and a_record.get("Type") == "A"
        )
    ...
    def test_jarombek_com_health_check_exists(self) -> None:
        ...
        """
        health_checks: List[dict] = self.route53.list_health_checks().get(
            "HealthChecks"
        )
        jarombek_com_health_checks = [
            health_check
            for health_check in health_checks
            if health_check.get("HealthCheckConfig").get("FullyQualifiedDomainName")
            == "jarombek.com"
        ]
    ...
    def test_saintsxctf_com_api_health_check_exists(self) -> None:
        ...
        health_check_config = saintsxctf_com_api_health_checks[0].get(
            "HealthCheckConfig"
        )
        self.assertEqual(443, health_check_config.get("Port"))
        self.assertEqual("HTTPS", health_check_config.get("Type"))
    ...
    def test_jarombek_com_health_check_alarm_exists(self) -> None:
        ...
        """
        alarms: List[dict] = self.cloudwatch.describe_alarms(
            AlarmNames=["jarombek-com-health-check-alarm"]
        ).get("MetricAlarms")
        ...
        alarm = alarms[0]
        self.assertEqual(
            "Determine if jarombek.com is down.", alarm.get("AlarmDescription")
        )
    ...
    def test_saintsxctf_com_health_check_alarm_exists(self) -> None:
        ...
        """
        alarms: List[dict] = self.cloudwatch.describe_alarms(
            AlarmNames=["saints-xctf-com-health-check-alarm"]
        ).get("MetricAlarms")
        ...
        alarm = alarms[0]
        self.assertEqual(
            "Determine if saintsxctf.com is down.", alarm.get("AlarmDescription")
        )
        self.assertEqual("OK", alarm.get("StateValue"))
        self.assertEqual("AWS/Route53", alarm.get("Namespace"))
        self.assertEqual("HealthCheckStatus", alarm.get("MetricName"))
    ...
    def test_saintsxctf_com_api_health_check_alarm_exists(self) -> None:
        ...
        """
        alarms: List[dict] = self.cloudwatch.describe_alarms(
            AlarmNames=["saints-xctf-com-api-health-check-alarm"]
        ).get("MetricAlarms")
        ...
        alarm = alarms[0]
        self.assertEqual(
            "Determine if api.saintsxctf.com is down.", alarm.get("AlarmDescription")
        )
        self.assertEqual("OK", alarm.get("StateValue"))
        self.assertEqual("AWS/Route53", alarm.get("Namespace"))
        self.assertEqual("HealthCheckStatus", alarm.get("MetricName"))
