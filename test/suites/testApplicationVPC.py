...
class TestSaintsxctfComApp(unittest.TestCase):
    ...
    def test_application_internet_gateway_exists(self) -> None:
        ...
        """
        self.assertTrue(
            len(VPC.get_internet_gateways("application-vpc-internet-gateway")) == 1
        )
    ...
    def test_application_sg_valid(self) -> None:
        ...
        self.validate_application_sg_rules(
    ...
    def test_application_lisag_public_subnet_rt_configured(self) -> None:
        ...
        internet_gateway = VPC.get_internet_gateways(
            "application-vpc-internet-gateway"
        )[0]
    ...
    def test_application_megank_public_subnet_exists(self) -> None:
        ...
        """
        self.assertTrue(
            len(VPC.get_subnets("saints-xctf-com-megank-public-subnet")) == 1
        )
    ...
    def test_application_cassiah_private_subnet_exists(self) -> None:
        ...
        """
        self.assertTrue(
            len(VPC.get_subnets("saints-xctf-com-cassiah-private-subnet")) == 1
        )
    ...
    def test_application_carolined_private_subnet_exists(self) -> None:
        ...
        """
        self.assertTrue(
            len(VPC.get_subnets("saints-xctf-com-carolined-private-subnet")) == 1
        )
    ...
    def test_kubernetes_grandmas_blanket_public_subnet_exists(self) -> None:
        ...
        """
        self.assertTrue(
            len(VPC.get_subnets("kubernetes-grandmas-blanket-public-subnet")) == 1
        )
    ...
    def validate_application_sg_rules(self, ingress: list, egress: list):
        ...
        ingress_neg1 = SecurityGroup.validate_sg_rule_cidr(
            ingress[2], "icmp", -1, -1, "0.0.0.0/0"
        )
        ingress_443 = SecurityGroup.validate_sg_rule_cidr(
            ingress[3], "tcp", 443, 443, "0.0.0.0/0"
        )
        ingress_9418 = SecurityGroup.validate_sg_rule_cidr(
            ingress[4], "tcp", 9418, 9418, "0.0.0.0/0"
        )
