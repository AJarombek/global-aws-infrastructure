...
class TestConfig(unittest.TestCase):
    ...
    def test_config_configuration_recorder_exists(self) -> None:
        ...
        """
        configuration_recorders_info: dict = (
            self.config.describe_configuration_recorders(
                ConfigurationRecorderNames=["jarombek"]
            )
        )
        configuration_recorders = configuration_recorders_info.get(
    ...
    def test_config_configuration_recorder_enabled(self) -> None:
        ...
        """
        configuration_recorders_info: dict = (
            self.config.describe_configuration_recorder_status(
                ConfigurationRecorderNames=["jarombek"]
            )
        )
        configuration_recorders = configuration_recorders_info.get(
    ...
    def test_aws_config_role_policy_attached(self) -> None:
        ...
        """
        policy_response = self.iam.list_attached_role_policies(
            RoleName="aws-config-jarombek"
        )
        policies = sorted(
            policy_response.get("AttachedPolicies"), key=lambda x: x.get("PolicyName")
        )
