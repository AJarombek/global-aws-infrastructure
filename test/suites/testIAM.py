...
class TestIAM(unittest.TestCase):
    ...
    def test_admin_group_exists(self) -> None:
        ...
        self.assertTrue(
            group.get("Path") == "/admin/" and group.get("GroupName") == "admin-group"
        )
    ...
    def test_andy_user_exists(self) -> None:
        ...
        self.assertTrue(
            user.get("Path") == "/admin/" and user.get("UserName") == "andy-user"
        )
    ...
    def test_andy_admin_group_membership(self) -> None:
        ...
        self.assertTrue(
            member.get("Path") == "/admin/" and member.get("UserName") == "andy-user"
        )
    ...
    def test_jenkins_role_exists(self) -> None:
        ...
        self.assertTrue(
            role.get("Path") == "/admin/" and role.get("RoleName") == "jenkins-role"
        )
    ...
    def test_admin_policy_attached(self) -> None:
        ...
        self.assertTrue(
            len(policies) == 2 and admin_policy.get("PolicyName") == "admin-policy"
        )
    ...
    def test_elastic_ip_policy_attached(self) -> None:
        ...
        self.assertTrue(
            len(policies) == 2
            and elastic_ip_policy.get("PolicyName") == "elastic-ip-policy"
        )
